...
隐故不自隐。古之所谓隐士者，非伏身而弗见也，非闭其言而不出也，非藏其知而不发也，时命大谬也。当时命而大行乎天下，则反一无迹；不当时命而大穷乎天下，则深根宁极而待。此存身之道也。
...
道通，其分也成也，其成也毁也。所恶乎分者，其分也以备；所以恶乎备者，其有以备。故出而不反，见其鬼；出而得，是谓得死。灭而有实，鬼之一也。
